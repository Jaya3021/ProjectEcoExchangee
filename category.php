...
if(isset($_REQUEST["submitbtn"]))
{
    ...
    $description=$result['p_desc'];
    $image= $result['p_img'];
   

    include('connection.php');
    $qry="INSERT INTO wishlist (`p_name`,`p_price`,`p_category`, `p_desc`,`p_img`) VALUES ('$name','$price','$category','$description','$image');";
...
<!-- header section-->
       <header class="header">
        ...
        <?php
	     include("connection.php");
	     $query = "SELECT * FROM uploads Where p_category='Musical Instrument' && email != '{$_SESSION['email']}' ";
